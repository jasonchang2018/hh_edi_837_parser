...
create or replace view
    edwprodhh.edi_837p_parser.export_ub
as
...
(
    select      *
    from        edwprodhh.edi_837p_parser.claim_additional_subscribers
...
(
    ...
    from        edwprodhh.edi_837p_parser.claims as claims
                ...
                left join
                    edwprodhh.edi_837p_parser.hl_billing_providers as hl_providers
                ...
                left join
                    edwprodhh.edi_837p_parser.hl_subscribers as hl_subscribers                   --effectively "claim_othersbr_a" for payer.
                    on  claims.response_id          = hl_subscribers.response_id
                    and claims.nth_transaction_set  = hl_subscribers.nth_transaction_set
                left join
                    edwprodhh.edi_837p_parser.hl_patients as hl_patients                         --effectively "claim_othersbr_a" for policyholder.
                ...
                left join
                    edwprodhh.edi_837p_parser.claim_service_lines as lx
