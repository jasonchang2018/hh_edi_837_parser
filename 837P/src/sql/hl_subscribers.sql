create or replace table
    edwprodhh.edi_837p_parser.hl_subscribers
as
with filtered_hl as
(
    select      *
...
create or replace task
    edwprodhh.edi_837p_parser.insert_hl_subscribers
...
(
    ...
    where       hl_index_billing_20         is not null                                          --0 Pre-Filter
                ...
                and hl_index_patient_23     is null
                and claim_index             is null
                and response_id not in (select response_id from edwprodhh.edi_837p_parser.hl_subscribers)
)
, subscriber_hl as
(
    with long as
